      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            // Changed z-index syntax for tailwind v4, removed fixed height constraint on inner content
          ...
          >
            ...
            <div className="flex justify-between items-center border-b border-white/10 p-8 md:px-12 md:pt-12 md:pb-6 shrink-0">
              <div className="flex items-center gap-4">
                <img src="/senol.png" alt="SENO Logo" className="w-10 h-10 object-contain rounded-md" />
              ...
              <div className="flex flex-col gap-2 pb-12">
                {['HOME', 'PROJECTS', 'ABOUT', 'CONTACT'].map((item) => (
                  <div key={item} className="group relative overflow-hidden py-2 border-b border-white/5">
                    {/* Changed font from Impact to default sans for consistency */}
